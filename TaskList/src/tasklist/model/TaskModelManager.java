...
public class TaskModelManager implements TaskModel
{
  ...
  @Override public void addTask(String owner, String disc)
  {
      Task task = new Task(owner, disc, calcTimeStamp());
      tasks.add(task);
  ...
  {
    Task removeTask = tasks.remove(0);
    support.firePropertyChange("taskRemoved", null, removeTask);
    return removeTask;
  }
}
